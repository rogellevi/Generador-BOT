...
SCPT_DIR="/etc/SCRIPT"
rm -f gera*
source <(curl -sSL https://raw.githubusercontent.com/rogellevi/Generador-BOT/main/Otros/msg) >/dev/null
#!/bin/bash
...
tittle() {
    ...
    clear && clear
    msg -bar
    echo -e "\033[1;44;44m   \033[1;33m=====>>►► 🐲 rogellevi 💥 Plus 🐲 ◄◄<<=====  \033[0m \033[0;33m[$(less /etc/${rt}/v-local.log)]"
    msg -bar
}
in_opcion() {
    unset opcion
...
[[ -d /bin/ejecutar ]] && {
    [[ -e /bin/ejecutar/msg ]] || wget -q -O /bin/ejecutar/msg https://raw.githubusercontent.com/rogellevi/Generador-BOT/main/Otros/msg
} || mkdir /bin/ejecutar
cor[0]="\033[0m"
cor[1]="\033[1;34m"
cor[2]="\033[1;32m"
...
fun_filez() {
    ...
    wget -O /bin/http-server.sh https://raw.githubusercontent.com/rogellevi/Generador-BOT/main/Bot/http-server.py  && chmod +x /bin/http-server.sh
...
atualiza_fun() {
    ...
    wget -q -O /usr/bin/sbg https://raw.githubusercontent.com/rogellevi/Generador-BOT/main/Menu-Bash/gerador.sh && chmod +x /usr/bin/sbg
    cd $HOME
    msg -bar
