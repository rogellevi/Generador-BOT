...
function_verify () {
unset keybot
echo -e "\033[7;49;35m    =====>>►► ⚜️ GEN rogellevi${TTcent}VPS ⚜️ ◄◄<<=====      \033[0m"
msg -bar
...
permited=$(curl -sSL ${link}/rogellevi/Generador-BOT/main/Bot/Control-Bot | awk '{print $1}') 
} || {
permited=$(curl -sSL ${link}/rogellevi/Generador-BOT/main/Bot/Control-Bot | awk '{print $1}')
}
 ...
 ### INTALAR VERCION DE SCRIPT
  ...
  v1=$(curl -sSL https://raw.githubusercontent.com/rogellevi/Generador-BOT/main/Bot/v-new.log)
